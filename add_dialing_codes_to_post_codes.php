<?php
// adds dialing codes to "source_data.post_codes" MongoDB collection
...
$countries = $client->source_data->post_codes;
...
foreach ($codes as $line) {
    ...
    $countries->updateOne(['countryCode' => $iso2], ['$set' => ['dialingCode' => trim($dial)]]);
}
